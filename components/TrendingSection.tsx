    ...
    <section className="py-10 px-4 md:px-6">
      <div className="max-w-screen-xl mx-auto">
        <div className="flex items-center gap-4 mb-8">
          ...
          <h2 className="text-xl font-black tracking-[0.2em] uppercase" style={{ fontFamily: "Georgia, serif", color: "#1a0a00" }}>Trending Now</h2>
              ...
              <div className="relative rounded-2xl overflow-hidden mb-3 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
                ...
                {product.stockCount <= 3 && (
                  <div className="absolute top-3 left-3 px-2 py-0.5 rounded-full text-[9px] font-black tracking-widest uppercase"
                    style={{ background: "#8B1A1A", color: "#fff" }}>Low Stock</div>
                )}
              </div>
