...
export default function ContactPage() {
  ...
  const focusIn  = (e: React.FocusEvent<HTMLInputElement | HTMLTextAreaElement>) => (e.target.style.border = "1.5px solid #C9A84C");
  const focusOut = (e: React.FocusEvent<HTMLInputElement | HTMLTextAreaElement>) => (e.target.style.border = "1.5px solid rgba(201,168,76,0.3)");
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
            {[
              ...
              },
              {
                ...
                label: "Email",
                value: "theperfumeclubtpc@gmail.com",
                href: "mailto:theperfumeclubtpc@gmail.com",
              },
              {
                icon: (
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#C9A84C" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                ...
                label: "Address",
                value: "1st Floor, Plot 1c/1, Lane 6, Zamzama, DHA, Karachi",
          ...
          >
            ...
            {!sent ? (
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      type="email"
                      required
                      placeholder="signaturebyfeeha@gmail.com"
                      value={form.email}
                ...
                <button
                  type="submit"
                  className="self-center px-12 py-3.5 rounded-xl text-xs font-black tracking-[0.25em] uppercase transition-all hover:scale-105 active:scale-95"
                  style={{
